...
public class ItemFlower extends ElementsFoodstuff.ModElement {
	@GameRegistry.ObjectHolder("foodstuff:flower")
	public static final Item block = null;
	public ItemFlower(ElementsFoodstuff instance) {
		super(instance, 17);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("foodstuff:flower", "inventory"));
	}
