...
public class ItemDough extends ElementsFoodstuff.ModElement {
	@GameRegistry.ObjectHolder("foodstuff:dough")
	public static final Item block = null;
	public ItemDough(ElementsFoodstuff instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("foodstuff:dough", "inventory"));
	}
