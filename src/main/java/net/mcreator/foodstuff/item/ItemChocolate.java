...
public class ItemChocolate extends ElementsFoodstuff.ModElement {
	@GameRegistry.ObjectHolder("foodstuff:chocolate")
	public static final Item block = null;
	public ItemChocolate(ElementsFoodstuff instance) {
		super(instance, 4);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("foodstuff:chocolate", "inventory"));
	}
