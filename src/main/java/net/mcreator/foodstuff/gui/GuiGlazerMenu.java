...
package net.mcreator.foodstuff.gui;
...
import net.mcreator.foodstuff.procedure.ProcedureOnGlazerMenuCraft;
...
public class GuiGlazerMenu extends ElementsFoodstuff.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiGlazerMenu(ElementsFoodstuff instance) {
		super(instance, 47);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 27, 25) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 27, 55) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 62, 40) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				Foodstuff.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("foodstuff:textures/glazermenu.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Glazer", 75, 6, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 98, this.guiTop + 38, 50, 20, "Glaze"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			Foodstuff.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureOnGlazerMenuCraft.executeProcedure($_dependencies);
			}
		}
	}
