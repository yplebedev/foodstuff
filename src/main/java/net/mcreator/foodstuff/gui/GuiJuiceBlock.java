...
import net.mcreator.foodstuff.procedure.ProcedureGivenItemInJuicer;
...
public class GuiJuiceBlock extends ElementsFoodstuff.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiJuiceBlock(ElementsFoodstuff instance) {
		super(instance, 53);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 25, 27) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 134, 27) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("foodstuff:textures/juiceblock.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Juicer", 78, 4, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 38, this.guiTop + 53, 100, 20, "Make juice"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureGivenItemInJuicer.executeProcedure($_dependencies);
			}
		}
	}
