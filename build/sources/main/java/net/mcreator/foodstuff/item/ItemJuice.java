...
public class ItemJuice extends ElementsFoodstuff.ModElement {
	@GameRegistry.ObjectHolder("foodstuff:juice")
	public static final Item block = null;
	public ItemJuice(ElementsFoodstuff instance) {
		super(instance, 58);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("foodstuff:juice", "inventory"));
	}
	public static class ItemFoodCustom extends ItemFood {
		public ItemFoodCustom() {
			super(6, 0.4f, false);
			setUnlocalizedName("juice");
