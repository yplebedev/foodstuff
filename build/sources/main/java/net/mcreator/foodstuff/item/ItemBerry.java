...
public class ItemBerry extends ElementsFoodstuff.ModElement {
	@GameRegistry.ObjectHolder("foodstuff:berry")
	public static final Item block = null;
	public ItemBerry(ElementsFoodstuff instance) {
		super(instance, 52);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("foodstuff:berry", "inventory"));
	}
