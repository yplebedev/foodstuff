...
public class StructureBananatree extends ElementsFoodstuff.ModElement {
	public StructureBananatree(ElementsFoodstuff instance) {
		super(instance, 44);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("foodstuff", "banana_tree"));
				if (template == null)
					return;
