...
public class BlockStrawberry extends ElementsFoodstuff.ModElement {
	@GameRegistry.ObjectHolder("foodstuff:strawberry")
	public static final Block block = null;
	public BlockStrawberry(ElementsFoodstuff instance) {
		super(instance, 51);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("foodstuff:strawberry", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemBerry.block, (int) (1)));
		}
