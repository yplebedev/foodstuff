...
public class BlockBamboo extends ElementsFoodstuff.ModElement {
	@GameRegistry.ObjectHolder("foodstuff:bamboo")
	public static final Block block = null;
	public BlockBamboo(ElementsFoodstuff instance) {
		super(instance, 24);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("foodstuff:bamboo", "inventory"));
	}
				...
				public boolean generate(World world, Random random, BlockPos pos) {
					for (int i = 0; i < 20; ++i) {
						...
						if (world.isAirBlock(blockpos1)) {
							...
							int j = 1 + random.nextInt(random.nextInt(14) + 1);
							j = Math.min(14, j);
							for (int k = 0; k < j; ++k)
