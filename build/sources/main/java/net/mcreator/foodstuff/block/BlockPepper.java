...
import net.mcreator.foodstuff.item.ItemPepperfood;
...
public class BlockPepper extends ElementsFoodstuff.ModElement {
	@GameRegistry.ObjectHolder("foodstuff:pepper")
	public static final Block block = null;
	public BlockPepper(ElementsFoodstuff instance) {
		super(instance, 6);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("foodstuff:pepper", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0.5F);
			setLightLevel(0.02F);
			setUnlocalizedName("pepper");
			setRegistryName("pepper");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemPepperfood.block, (int) (3)));
		}
