...
public class BlockRice extends ElementsFoodstuff.ModElement {
	@GameRegistry.ObjectHolder("foodstuff:rice")
	public static final Block block = null;
	public BlockRice(ElementsFoodstuff instance) {
		super(instance, 28);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("foodstuff:rice", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemRiceItem.block, (int) (5)));
		}
